...
module.exports = function(app){
   ...
   app.get('/user/demandeDocs', redirectLogin, function(req,res){
           ...
           db.query(docs, (err, result)=>{
               ...
               res.render('admin/documents/demandeDocs',{title, data: result});
           })
       ...
       app.post('/user/sendDemande', urlencodedParser, function(req,res){
        ...
        let notif = "insert into notifications(demande_id,data,created_at) values("+result2[0].id_demande+", 'User: "+user_name+", Nom document: "+docname+"', now())";
...
/*/ RETURN NOTIFICATION DETAIL PAGE*/
  app.get('/user/notifDtails/:id', function(req,res){
      ...
      var nom_doc= data[1];
      var nom_user = data[0];
      console.log("user name: "+nom_user+" doc name: "+nom_doc)
      ...
      db.query(deminf, (err2,result2)=>{
         ...
         if(result20[0].type_notif === 2){
             ...
             db.query(docInf, (err9,result9)=>{
                ...
                res.render('admin/users/notifpage',{title, nom_doc, nom_user,id,accepted,titre,type,data:result9});
         ...
         if(result3[0] === undefined){
            ...
            res.render('admin/users/notifpage',{title, nom_doc, nom_user,id,accepted,user_accept,titre,type});
            ...
            if(result4[0] === undefined){
                var id_profile= 0;
                res.render('admin/users/notifpage',{title, nom_doc, nom_user,id,accepted,user_accept,id_profile,titre,type});
  ...
  app.post('/user/acceptedDemande', urlencodedParser,function(req,res){
              ...
              let updDemande = "UPDATE demande SET accepter=1,updated_date=now() WHERE id_demande= "+dem_id+" " //Update the demande data
                  db.query(updDemande, (err2,result2)=>{
                      ...
                      db.query(accepted_date, (err3,result3)=>{
                          ...
                          let update_notif = "update notifications set read_at=now() where id_notif="+notif_id+""
                          ...
                          //if(result1[0].doc_id === NULL){
                            ...
                            if(result1[0].doc_id !== null){
                              ...
                              db.query(docInf, (err3, result3)=>{
                                  ...
                                  res.render('admin/UserDocuments/createDocs',{title,docExist,docName,description,doc_name,notif_id});
                              ...
                              res.render('admin/UserDocuments/createDocs',{title,docExist,doc_name,notif_id});
